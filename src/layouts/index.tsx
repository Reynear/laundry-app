...
export function DashboardLayout({ children, user, currentPath }) {
	const SidebarComponent =
		user.role === "student" ? ClientSidebar : StaffSidebar;

	return (
		<BaseLayout title="Laundry App">
			<SidebarComponent user={user} currentPath={currentPath} />
	...
	return (
		...
		>
			<div className="h-full px-3 py-4 overflow-y-auto">
				<BrandLogo variant="sidebar" subtitle="User Portal" />
...
function StaffSidebar({ user, currentPath }) {
	...
	return (
		...
		>
			<div className="h-full px-3 py-4 overflow-y-auto">
				<BrandLogo variant="sidebar" subtitle="Staff Portal" />
				<UserProfile user={user} />
				<ul className="space-y-1">
					{links.map((item) => (
						<SidebarLink
