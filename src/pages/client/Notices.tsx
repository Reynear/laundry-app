import { NoticeCard } from "../../features/dashboard/components/DashboardComponents";
...
export function Notices({
	...
	notices: Notice[];
	halls: Hall[];
	selectedHallId: number | "all";
}) {
	// Only render for normal users; other roles redirected at the route level
	return (
		<main class="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
			...
			<div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
				...
				<select
					...
					hx-trigger="change"
				>
					<option value="all" selected={selectedHallId === "all"}>
						All Halls
					</option>
					{halls.map((hall) => (
